...
describe('/api/genres', () => {
    ...
    describe('GET /', () => {
        ...
        describe('POST /', () => {
            ...
            //parameter that clearly algins with the name of the test.
        ...
        describe('PUT /:id', () => {
            ...
            beforeEach(async () => {
                ...
                //Before each test we create new genre and put in database
        ...
        describe('DELETE /:id', () => {
            ...
            beforeEach(async () => {
                //Before each test we need to greate a genre and put in db.
